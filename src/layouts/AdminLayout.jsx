...
import {
  ...
  Users, BarChart3, Settings, LogOut, Menu, Monitor, Truck, ShoppingCart, Image
} from 'lucide-react';
...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-100 dark:bg-gray-900">
      <aside className={`fixed inset-y-0 right-0 z-50 w-64 bg-white dark:bg-gray-800 border-l dark:border-gray-700 transform transition-transform lg:translate-x-0 lg:static ${sidebarOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <nav className="p-4 space-y-1">
          ...
          {hasPermission('pos.use') && isAdmin && (
            <NavLink to="/admin/pos" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
              <Monitor size={20} /> نقطة البيع
            </NavLink>
          )}
          <Link to="/" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
